...
class JoystickController(object):
    ...
    def run_threaded(self, img_arr=None):
        ...
        return self.angle, self.throttle, self.mode, self.recording, self.photo#13_09
...
class XboxOneJoystickController(JoystickController):
    ...
    def init_trigger_maps(self):
        ...
        '''
        #possible to modify to make a photo using X

        self.button_down_trigger_map = {
            'a_button': self.toggle_mode,
            'b_button': self.toggle_manual_recording,
            'x_button': self.make_photo,
