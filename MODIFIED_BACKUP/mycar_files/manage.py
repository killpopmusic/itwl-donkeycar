...
def drive(cfg, model_path=None, use_joystick=False, model_type=None, camera_type='single', meta=[] ):
    ...
    This enables easy addition and removal of the parts 
    '''
    ...
    from donkeycar.parts.luna import Luna   
    lidar = Luna()    
        
    V.add(lidar, inputs=[], outputs=['distance'], threaded=threaded) #21_09 adding the luna lidar for testing
    ...
    V.add(ctr, 
          inputs=['cam/image_array', 'distance'],
